...
export function AccountBox(props){
    ...
    const contextValue = { switchToSignup, switchToSignin, switchToConfirm, switchToResend};
    return<AppContainer>
    ...
    <BoxContainer>
        <TopContainer>
            ...
            <HeaderContainer>
              ...
              <HeaderText>Account</HeaderText>
              <SmallText>Please enter code sent to 
